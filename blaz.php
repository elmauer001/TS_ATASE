...
<body>
	...
	<div class="clearfix">
		<picture>
			<img class="img1" src="slike/blaz_opis.jpg" alt="Blaž_original">
			<img class="img2" src="slike/blaz500px.jpg" alt="Blaž_mala">
			<img class="img3" src="slike/blaz400px.jpg" alt="Blaž_manja">
			<img class="img4" src="slike/blaz360px.jpg" alt="Blaž_najmanja">
		</picture>
		<p class="font_change">Blaž je glavni vokal sastava i prvi basprimaš. Može se reći da je glazba njegova najveća ljubav. Inače
